...
<div class="flex">
    ...
    <div
      ...
      class="fixed z-30 inset-y-0 left-0 w-64 transition duration-300 transform bg-white border-r dark:bg-gray-800 dark:border-gray-600 overflow-y-auto lg:translate-x-0 lg:static lg:inset-0"
    >
        ...
        <div class="flex flex-col items-center mt-6">
            ...
            <p class="mx-2 mt-1 text-sm font-medium text-gray-600 dark:text-gray-400 hover:underline">QQmember since {{ formatedJoinDate }}</p>
        </div>

        <div class="flex flex-col justify-between flex-1 mt-6">
            
            <nav>
                <router-link class="flex items-center px-4 py-2"
  ...
  name: "Aside",
   setup(){
    ...
    const inactiveClass = ref(
     ...
     const formatedJoinDate = computed(() => (new Date(+user.value.joinDate)).toLocaleDateString())
